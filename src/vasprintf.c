 ...
 */
static int
realloc_buff (xprintf_struct * s, size_t len)
{
  char *ptr;
 ...
 */
static int
print_it (xprintf_struct * s, size_t approx_len,
 ...
 */
static int
type_s (xprintf_struct * s, int width, int prec,
...
int
vasprintf (char **ptr, const char *format_string, va_list vargs)
{
  xprintf_struct s;
  int retval;
