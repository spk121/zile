/* Registers facility functions
   ...
   Copyright (c) 2001, 2003, 2004, 2005, 2006, 2008, 2009, 2010, 2011 Free Software Foundation, Inc.
...
{
  undo_save (UNDO_REPLACE_BLOCK, get_buffer_pt_o (cur_bp), 0, astr_len (regs[regnum].as));
  undo_nosave = true;
